  ...
  return (
    <div className={style.wrapper}>
        ...
        < div className={style.inputBoxes}>
          {/* the box for the pickup location */}
        <div
        ...
        >
          <div className={style.svgContainer}>
            {/* for the dot in the enter your location box */}
          ...
          {/* for the vertical line from the enter your location box */}
          <div className={style.verticalLine}/>
          {/* the box for the drop location */}
          <div
          className={`${style.inputBox} ${
            inFocus === 'to' && style.focusedInputBox 
          }`}
        >
          {/* the square svg in the drop location box */}
            <div className={style.svgContainer}>
            <svg viewBox='0 0 24 24' width='1em' height='1em'>
              <path
                fillRule='evenodd'
